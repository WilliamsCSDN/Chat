...
> - `MILVUS_EMBEDDING_MODEL`（默认 `sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2`）
> - `MILVUS_EMBEDDING_MODEL_PATH`（默认 `test/milvus/models/paraphrase-multilingual-MiniLM-L12-v2`，存在时优先离线加载）
